    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-navy-500">{t(lang, modeKey)}</p>
        </div>
      ...
      {err && (
        <p className="mb-3 text-sm text-red-700 bg-red-50 border border-red-100 rounded px-3 py-2">{err}</p>
      )}
      ...
      {joined && isTurn && mySeat && !mySeat.folded && (
        <div className="mt-6 flex flex-wrap gap-2 items-center">
          <button
            type="button"
            onClick={() => act('fold')}
            className="rounded-lg border border-navy-200 px-4 py-2 text-sm font-medium text-navy-900"
          >
            {t(lang, 'fold')}
          </button>
          <button
          ...
          <button
            type="button"
            onClick={() => act('call')}
            className="rounded-lg bg-navy-800 text-white px-4 py-2 text-sm font-medium"
          >
            {t(lang, 'call')}
          </button>
          <input
          ...
          <button
            type="button"
            onClick={() => act('allin')}
            className="rounded-lg border border-navy-900 px-4 py-2 text-sm font-medium text-navy-900"
          >
            {t(lang, 'allin')}
          </button>
