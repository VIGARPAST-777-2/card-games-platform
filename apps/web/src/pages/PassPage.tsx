...
const MISSIONS = [
  {
    ...
    description: 'Completa tres partidas de cualquier modo',
    reward_coins: 50,
    reward_xp: 25,
  },
  {
    id: '2',
    title: 'Gana 1 partida',
    description: 'Consigue una victoria',
    reward_coins: 80,
    reward_xp: 40,
  },
  {
    id: '3',
    title: 'Racha de 2 días',
    description: 'Entra dos días seguidos',
    reward_coins: 100,
    reward_xp: 30,
  },
];
...
export function PassPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      <h1 className="font-brand text-3xl text-navy-900 mb-2">Pase de temporada</h1>
      ...
      <div className="rounded-xl bg-navy-900 text-white p-6 mb-8 shadow-card">
        <div className="flex justify-between items-end mb-3">
          <div>
            ...
            <div className="font-brand text-3xl">{tier}</div>
          </div>
